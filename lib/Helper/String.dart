...
final Uri getImageSliderApi = Uri.parse('${baseUrl}get_slider_images_bottom');
...
final Uri getDeliveryChargeApi = Uri.parse('${baseUrl}get_delivery_charge');
...
// final Uri myfatoorahUpdateTransactionApi =
//     Uri.parse('${baseUrl}myfatoorah_update_transaction');
...
const String CANCEL_REASON = 'cancel_reason';
...
const String GSTKEY = 'gst_number';
...
const String ProductBrandID = "brand_id";
